CREATE OR REPLACE PACKAGE PAQUETE_PEDIDO AS
    PROCEDURE CREAR_PEDIDO(ruc PEDIDO.RUC%TYPE, condicion PEDIDO.CONDICION_PAGO%TYPE, nro_comprobante PEDIDO.N_COMPROBANTE%TYPE);
    PROCEDURE REGISTRAR_PRODUCTOS(ruc PEDIDO.RUC%TYPE, cantidad PEDIDO_PRODUCTO.CANTIDAD%TYPE, codigo_pro PRODUCTO.COD_PRODUCTO%TYPE);
...
CREATE OR REPLACE PACKAGE BODY PAQUETE_PEDIDO AS
    ...
    BEGIN
        ...
        INSERT INTO PEDIDO VALUES (n_pedido, ruc, cod_vendedor, condicion, nro_comprobante, 0, 0, fecha);
    END CREAR_PEDIDO;
    ...
    BEGIN
        INSERT INTO PEDIDO_PRODUCTO VALUES (n_pedido, ruc, codigo_pro, cantidad);
